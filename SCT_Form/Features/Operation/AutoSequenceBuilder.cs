...
namespace SCT_Form
{
    internal static class AutoSequenceBuilder
    {
            ...
            Action<string, int, bool> setFoupSlotState)
        {
            ...
            AddWaitSensor(steps, displayModule, label + " - cylinder front wait", main.IsCylinderForward);
            ...
            AddWaitSensor(steps, displayModule, label + " - cylinder back wait", main.IsCylinderBack);
            ...
            Action<string, bool> setModuleWaferState)
        {
            ...
            AddWaitSensor(steps, module, label + " - cylinder back wait", main.IsCylinderBack);
